"""
Logging configuration for CareerPilotAI system.
...
class CareerPilotAILogger:
    """Centralized logger for CareerPilotAI system."""
    
    def __init__(self, name: str = "careerpilotai", level: str = "INFO"):
        self.name = name
    ...
    log_file = log_dir / f"careerpilotai_{datetime.now().strftime('%Y%m%d')}.log"
...
_logger_instance: Optional[CareerPilotAILogger] = None


def get_logger(name: str = "careerpilotai", level: str = "INFO") -> CareerPilotAILogger:
    """Get or create a logger instance."""
    global _logger_instance
    
    if _logger_instance is None:
        _logger_instance = CareerPilotAILogger(name, level)
...
def setup_logging(level: str = "INFO", log_to_file: bool = True):
    ...
    logger = get_logger("careerpilotai", level)
    
    # Log the setup
    logger.info("🚀 CareerPilotAI logging system initialized", 
               level=level, 
