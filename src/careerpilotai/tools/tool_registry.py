"""
Tool Registry - Manages all available tools for the CareerPilotAI system.
"""
...
from careerpilotai.mcp.server_connections import mcp_servers

# Other imports
from careerpilotai.utils.logger import get_logger

logger = get_logger("tool_registry")


class ToolRegistry:
    """Registry for managing all available tools in the CareerPilotAI system."""
